...
python scripts/train_best_2et_nohumidity_dirichlet.py `
  --data-dir src/gaz_competition/data `
...
| --- | --- | --- |
| `--data-dir` | `src/gaz_competition/data` | Dossier contenant `X_train.csv`, `X_test.csv`, `y_train.csv`. |
...
| `src/gaz_competition/data/` | CSV d'entree. |
