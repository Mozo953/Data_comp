...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default="artifacts_extratrees_corr_optuna/05_expeirments_log_optuna_45", help="Directory to save artifacts.")
    parser.add_argument("--submission-prefix", default="log_ratios_optuna_45", help="Submission filename prefix.")
    ...
    parser.add_argument("--max-selected-features", type=int, default=45, help="Maximum number of features kept after signal and correlation pruning.")
