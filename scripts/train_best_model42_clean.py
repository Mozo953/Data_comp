...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default="artifacts_extratrees_corr_optuna/47_best_model42_clean")
    parser.add_argument("--submission-prefix", default="best_model42_clean")
    ...
    if args.cv_folds != 3:
        raise ValueError("Best model 42 is defined with CV=3.")
    return args
...
def main() -> None:
    ...
    summary = {
        ...
        "model": "Clean CV3 best model 42: et_rowagg_mf06_bs + et_allpool_3",
        "training": {
            "cv_folds": int(args.cv_folds),
            "random_state": int(args.random_state),
            "n_jobs": int(args.n_jobs),
