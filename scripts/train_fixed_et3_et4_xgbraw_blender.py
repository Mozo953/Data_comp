...
FIXED_ET_PARAMS = {
    ...
    "et_allpool_4": {
        ...
        "min_samples_leaf": 7,
        "max_features": 0.35561376442518655,
        "max_samples": 0.7018001722878066,
        "bootstrap": True,
        "random_state": 115,
        "n_jobs": -1,
    },
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Reuse fixed ET3, ET4, and raw XGB configs, recompute CV=3 OOFs, then retrain the target-wise constrained Dirichlet blend and calibration."
    )
    parser.add_argument("--data-dir", default="src/odor_competition/data")
    parser.add_argument("--output-dir", default="artifacts_extratrees_corr_optuna/15_fixed_et3_et4_xgbraw_blender")
    parser.add_argument("--submission-prefix", default="fixed_et3_et4_xgbraw_blender")
...
def main() -> None:
    ...
    summary = {
        ...
        "model": "Fixed et_allpool_3 + fixed et_allpool_4 + fixed raw XGB + constrained Dirichlet target-wise blend + calibration",
        ...
        "notes": {
            ...
            "base_model_reuse": "et_allpool_3, et_allpool_4, and raw XGB reuse fixed best-known hyperparameters; only CV predictions, blend, and calibration are retrained.",
            "ensemble_diversity": "et_allpool_3 and et_allpool_4 share the same full generated feature pool but keep structurally different ExtraTrees configurations and random states; XGB uses fixed raw-only settings.",
