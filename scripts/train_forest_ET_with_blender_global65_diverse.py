...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train 5 diversified ExtraTrees models from a shared global-65 subset with model-specific local random subsets.")
    parser.add_argument("--data-dir", default="src/odor_competition/data")
    parser.add_argument("--output-dir", default="artifacts_extratrees_corr_optuna/13_et5_global65_diverse")
    parser.add_argument("--submission-prefix", default="et5_global65_diverse")
...
def main() -> None:
    ...
    summary = {
        ...
        "model": "5x ExtraTrees on shared global-65 subset + model-specific local random subsets + Dirichlet target-wise blend + calibration",
        ...
        "notes": {
            ...
            "ensemble_diversity": "All 5 ExtraTrees share the same globally selected 65 features, then each model uses a different local random subset fraction, plus a different seed and hyperparameter ranges.",
        },
        "preprocessing": {
